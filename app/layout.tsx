      ...
      <body className={`${geistSans.className} ${dmMono.variable} ${instrumentSans.variable} antialiased sm:px-0 px-2`}>
        ...
        <footer className="w-full border-gray-300 bg-[#fffefb] border-t">
          <div className="max-w-[1440px] mx-auto border-x border-gray-300">
            {/* Footer Content */}
            <div className="flex justify-between gap-8 p-8 lg:p-8 border-b border-gray-300 items-center flex-wrap">
              {/* Left: Logo */}
              <div>
              ...
              <div className="flex justify-end">
                <nav className="flex gap-8 text-sm text-gray-600 flex-wrap">
                  <a href="/blogs" className="underline text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white text-base transition-colors font-mono">Blog</a>
            ...
            <div className="flex justify-between gap-6 border-b border-gray-300 p-8 flex-wrap">
              ...
              <div className="flex gap-5">
                <a href="https://www.linkedin.com/company/apstic" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-gray-600 hover:text-[#FF4A00] transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                </a>
                <a href="https://www.instagram.com/apstic_ai/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-gray-600 hover:text-[#FF4A00] transition-colors">
